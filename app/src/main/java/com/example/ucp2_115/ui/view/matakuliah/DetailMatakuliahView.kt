...
import com.example.ucp2_115.ui.viewmodel.matakuliah.DetailMatakuliahUiState
import com.example.ucp2_115.ui.viewmodel.matakuliah.DetailMatakuliahViewModel
import com.example.ucp2_115.ui.viewmodel.matakuliah.PenyediaMatakuliahViewModel
import com.example.ucp2_115.ui.viewmodel.matakuliah.toMatakuliahEntity
...
fun ComponentDetailMatakuliah(
    ...
    Row(
        ...
        Text(
            ...
            color = Color.Black,
            modifier = Modifier.weight(1f) // Mengatur judul agar mengambil ruang yang diperlukan
        )
        Text(
            text = isinya,
            fontSize = 20.sp,
            fontWeight = FontWeight.Bold,
            color = Color.Black,
            modifier = Modifier.weight(2f) // Mengatur isi agar fleksibel
        )
    }
}
