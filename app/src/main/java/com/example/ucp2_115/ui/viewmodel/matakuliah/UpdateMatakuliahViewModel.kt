...
import com.example.ucp2_115.ui.navigation.DestinasiMatakuliahUpdate
...
class UpdateMatakuliahViewModel(
    ...
    private val _kode: String = checkNotNull(saveStateHandle[DestinasiMatakuliahUpdate.KODE])
